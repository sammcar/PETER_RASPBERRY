...
void pokemon(std::string text, int num) {
    ...
    std::string mp3_file = "/home/peter/Desktop/PI3/Audio/audios/";
    
    if (num == 1) {
        mp3_file += "pikachu.mp3";  
    } else if (num == 2) {
        mp3_file += "squartul.mp3";  
    }
...
int main() {
    ...
    int last_number = -1;  // Para almacenar el último número recibido
    ...
    while (true) {
        ...
        if (commaPos != std::string::npos) {
            ...
            // Si el número es el mismo que el anterior, esperar 10 segundos antes de continuar
            // if (number == last_number) {
            //     std::cout << "⏳ Mismo número recibido (" << number << "), esperando 10 segundos...\n";
            //     sleep(10);
            //     continue;  // Volver al inicio del bucle sin reproducir
            // }

            // Actualizar el último número recibido
            last_number = number;
